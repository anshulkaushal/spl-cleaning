<?php
/**
 * Root index.php - Entry point for the website
 * This file should be in public_html/ root directory
 */
...
if (!file_exists(__DIR__ . '/includes/config.php')) {
    ...
    <p><strong>config.php not found!</strong></p>
    <p>Please ensure:</p>
    <ul>
        <li>You have copied <code>config.php.example</code> to <code>config.php</code></li>
        <li>The <code>includes/</code> folder exists in the same directory as this file</li>
        <li>File structure is correct</li>
    </ul>
    <p>Current directory: ' . __DIR__ . '</p>
    <p>Looking for: ' . __DIR__ . '/includes/config.php</p>
    ');
}

// Redirect to public/index.php if it exists, otherwise show error
if (file_exists(__DIR__ . '/public/index.php')) {
    // Files are in subdirectory structure
    require_once __DIR__ . '/public/index.php';
} else {
    // Try to include directly (if files are in root)
    $pageTitle = 'Home';
